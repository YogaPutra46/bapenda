    ...
    <div class="flex h-screen">
        ...
        <div class="bg-white w-64 h-screen fixed z-50 transform transition-transform duration-300 shadow-lg"
            ...
            <nav class="mt-4">
                ...
                <a href="/user" class="block py-2 px-4 hover:bg-gray-200"> KELOLA USER/a>
                <a href="/admin" class="block py-2 px-4 text-blue-600 font-semibold hover:bg-gray-200">KELOLA ADMIN</a>
            ...
            <div class="p-4">
                <div class="container mx-auto my-5">
                    <div class="bg-white shadow-lg rounded-lg">
                        ...
                        <div class="p-6">
                            <form action="{{ route('kelola_admin.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mt-4 flex justify-between">
                                    ...
                                    <a href="{{ route('kelola_admin.index') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg inline-flex items-center">
