                ...
                <div class="container mx-auto my-5">
                    <div class="bg-white shadow-lg rounded-lg">
                        <div class="bg-gray-100 text-center py-3 rounded-t-lg">
                            <strong class="text-xl">UBAH DATA</strong>
                        </div>
                        <div class="p-6">
                            <form action="{{ route('kelola_admin.update', $admin) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mt-4 flex justify-between">
                                    ...
                                    <a href="{{ route('admin.index') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg inline-flex items-center">
